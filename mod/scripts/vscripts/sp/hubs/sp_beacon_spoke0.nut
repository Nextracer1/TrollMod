...
void function StartPoint_Start( entity player )
{
	...
	Objective_Set( "#BEACON_OBJECTIVE_FOLLOW_TRANSPONDER" )
	Objective_Remind()
	wait 10

	Objective_Set( "#BEACON_OBJECTIVE_RETURN_TO_BEACON_CONTROL" )
	Objective_Remind()
	wait 10

	Objective_Set( "#OBJECTIVE_TEST_LOCATION" )
	Objective_Remind()
	wait 10

	Objective_Set( "#OBJECTIVE_TEST_NO_LOCATION" )
	Objective_Remind()
	wait 10

	Objective_Set( "#OBJECTIVE_TEST_ENTITY" )
	Objective_Remind()
	wait 10
	*/
...
void function EntitiesDidLoad()
{
	...
	// unused
	//thread Dev_TestAllConversations()
}
...
void function WallrunFansDialogueAndNPC( entity player )
{
	...
	{
		chatAliases.append( ["Grunt_FanWallrun_Death1"] )	// Looks like you've been to hell and back... We're glad you made it, Pilot.
		chatAliases.append( ["Grunt_FanWallrun_Death2"] )	// I can't imagine what you just went through down there. Great work, Pilot.
		chatAliases.append( ["Grunt_FanWallrun_Death3"] )	// You made it all the way around and found an Arc Tool. If I had a medal I'd give it to you. Well done, sir.
	}
...
void function DronePlatformsGroup1()
{
	...
	drone01.SetOrigin( < -1201, 2492, 452 > )
	drone02.SetOrigin( < -1201, 2492, 452 > )
	drone03.SetOrigin( < -1201, 2492, 452 > )
	drone04.SetOrigin( < -1201, 2492, 452 > )
	drone05.SetOrigin( < -1201, 2492, 452 > )
}
...
void function DronePlatformsGroup2()
{
	...
	drone08.SetOrigin( < -1201, 2492, 452 > )
}
