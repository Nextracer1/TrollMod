...
{
	Dev_PrintMessage( player, "whats poppin", "gamers", 5 )
...
*/
	...
	//He's here!
	thread PlayTimeShiftDialogue( player, loudspeakerEnt1, "diag_sp_humanStudy_TS202_01_01_imc_scientist1" ) 
...
void function HumanPodThinkPristine( entity door = null, entity bodySpawner = null )
{
	...
	labRat.SetModel( ANDERSON_MODEL ) 
