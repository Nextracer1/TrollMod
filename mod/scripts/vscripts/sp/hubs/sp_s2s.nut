...
//	RegisterDialogue( "diag_sp_maltaGuns_STS291_01_01_mcor_droz", "diag_sp_maltaGuns_STS291_01_01_mcor_droz", PRIORITY_NO_QUEUE )
	waitthreadsolo PlayDialogue("diag_sp_maltaGuns_STS291_01_01_mcor_droz", file.droz)
}
...
void function BT_Tackle_Main( entity player )
{
	...
	//sequence2.attachment = "REF"
	//sequence2.firstPersonAnim 	= "ptpov_s2s_viper_returns_end"
	//sequence2.thirdPersonAnim 	= "pt_s2s_viper_returns_end"
	//sequence2.viewConeFunction 	= ViewConeTight
	//sequence2.useAnimatedRefAttachment = true
	//sequence2.teleport			= false
	//sequence2.hideProxy			= false
	//waitthread FirstPersonSequence( sequence2, player, node )
...
void function TEST_GoblinModels( entity player )
{
	...
	//ShipStruct substituteGoblin = SpawnDSCombatTest( CLVec( < -300, 5000, 1000> ) )
	//ShipStruct substituteLightGoblin = SpawnDSCombatTest( CLVec( <300, 5000, 1000> ) )
...
void function DropshipCombatTestMain( entity player )
{
	...
	//ShipStruct ship2 = SpawnGoblin( pos )
	//ShipStruct ship2 = SpawnDSCombatTest(pos) 
	ShipStruct ship2 = SpawnGoblinLight(pos)
	DisableHullCrossing( ship2 )
	SetChaseEnemy( ship2, player ) 
	SetBehavior( ship2, eBehavior.ENEMY_CHASE )
