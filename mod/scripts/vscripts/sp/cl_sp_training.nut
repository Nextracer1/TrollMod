...
void function LevelIntroText_Think()
{
	...
	RuiSetString( infoText, "txtLine1", "B A L L S" )
	RuiSetString( infoText, "txtLine2", "(fortnite balls)" )
	...
	RuiSetString( infoText2, "txtLine2", "(sussy fortnite balls)" )
	RuiSetString( infoText2, "txtLine3", "" )
}
