...
void function CodeCallback_MapInit()
{
	...
	// AddStartPoint( "Trailer - Drop", 			StartPoint_TrailerDrop ) // UNUSED interesting
...
void function StartPoint_TdayIntro( entity player )
{
	...
	thread TitanfallTracers() // UNUSED
...
void function StartPoint_OLALaunch( entity player )
{
	...
	thread PlayerBlastedBack( player ) // UNUSED interesting
...
void function EnableMegaTurret( entity turret ) // interesting
{
	turret.EnableTurret()
}
...
void function ArkSequence( entity player )
{
	...
	// UNUSED
	asset weaponAsset = GetWeaponInfoFileKeyFieldAsset_Global( weaponName, "playermodel" ) // interesting
	entity weapon = CreatePropDynamic( weaponAsset )
	weapon.SetParent( titan, "propgun", false, 0.0 )
	// UNUSED
