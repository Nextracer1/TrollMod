...
const string OG_WEAPON = "mp_titanweapon_leadwall"
...
{
	file.trollDifficulty = GetConVarInt( "troll_difficulty" )

	if ( file.trollDifficulty < 1 )
		TRAINING_GAUNTLET_MAX_TIME_TO_PROGRESS = 60.0

	else if ( file.trollDifficulty == 1 )
		TRAINING_GAUNTLET_MAX_TIME_TO_PROGRESS = 37
		
	else                         
		TRAINING_GAUNTLET_MAX_TIME_TO_PROGRESS = 22
...
void function Training_PlayerDidLoad( entity player )
{
	...
	SetConVarFloat( "sv_gravity", 750.0 )
...
void function PodIntro_MeetOG( entity player )
{
	...
	asset btWeaponModel = GetWeaponInfoFileKeyFieldAsset_Global( "mp_weapon_rspn101", "playermodel" )
...
void function Training_ZenGarden( entity player )
{
	...
	ToggleFirstWallrunTrollSettings( player, true )
	...
	player.SetPlayerSettingsWithMods( TRAINING_PLAYER_SETTINGS, [] )
	ToggleFirstWallrunTrollSettings( player, false )
...
void function ToggleFirstWallrunTrollSettings( entity player, bool enable )
{
	// todo: another solution that doesn't require sv_cheats 1 would be way better
	//player.SetPlayerSettingsWithMods( TRAINING_PLAYER_SETTINGS, [] )

	if ( file.trollDifficulty > 0 ) 
		SetConVarFloat( "wallrun_enable", enable ? 0 : 1 )

	if ( file.trollDifficulty == 1 ) 
		SetConVarFloat( "sv_gravity", enable ? 625.0 : 750.0 )
}
...
void function CadillacMoment_MeetOG( entity player )
{
	...
	string gruntRifleName 		= "mp_titanweapon_sniper"
	string andersonWeaponName 	= "mp_titanweapon_leadwall"
	...
	asset playerWeaponModel = GetWeaponInfoFileKeyFieldAsset_Global( "mp_weapon_semipistol", "playermodel" )
...
void function PodOutro_Background_Runners( entity player )
{
	...
	thread SpawnSkitGuy_AndRun( "runner_1_1", path2, 0.85, TEAM_MILITIA, "npc_soldier_specialist_militia", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_1_2", path2, 0.85, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )

	wait 6.5  // wait until OG hands the eye to BT

	printt( "BACKGROUND RUNNER GROUP 2" )

	thread SpawnSkitGuy_AndRun( "runner_2_1", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_2_2", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_sniper" )

	wait 4.5  // wait until OG is shaking Anderson's hand

	printt( "BACKGROUND RUNNER GROUP 3" )

	thread SpawnSkitGuy_AndRun( "runner_3_1", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_3_2", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_sniper" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_3_3", path2, 0.8, TEAM_MILITIA, "npc_soldier_specialist_militia", "mp_titanweapon_sniper" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_3_4", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )

	wait 4.5  // wait until OG is mounting up

	printt( "BACKGROUND RUNNER GROUP 4" )

	thread SpawnSkitGuy_AndRun( "runner_4_1", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_4_2", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_sniper" )

	wait 6.5  // wait until OG thumbs up

	printt( "BACKGROUND RUNNER GROUP 5" )

	thread SpawnSkitGuy_AndRun( "runner_5_1", path2, 0.85, TEAM_MILITIA, "npc_soldier_specialist_militia", "mp_titanweapon_leadwall" )
	wait 1.2
	thread SpawnSkitGuy_AndRun( "runner_5_2", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_5_3", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_sniper" )
	wait 1.5
	thread SpawnSkitGuy_AndRun( "runner_5_4", path2, 0.85, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "runner_5_3", path2, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_sniper" )
	wait 1.5
	thread SpawnSkitGuy_AndRun( "runner_5_4", path2, 0.85, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
...
void function PodOutro_Foreground_Runners( entity player )
{
	...
	thread SpawnSkitGuy_AndRun( "close_runner_1", pathClose, 0.7, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.2
	thread SpawnSkitGuy_AndRun( "close_runner_2", pathClose, 0.75, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )

	wait 10.0  // wait for OG to start embarking BT

	thread SpawnSkitGuy_AndRun( "close_runner_4", pathClose, 0.75, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.3
	thread SpawnSkitGuy_AndRun( "close_runner_5", pathClose, 0.8, TEAM_MILITIA, "npc_soldier_specialist_militia", "mp_titanweapon_particle_accelerator" )

	wait 11  // wait for grunt to hand player the weapon

	thread SpawnSkitGuy_AndRun( "close_runner_10", pathClose, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.8
	thread SpawnSkitGuy_AndRun( "close_runner_11", pathClose, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
	wait 1.0
	thread SpawnSkitGuy_AndRun( "close_runner_12", pathClose, 0.8, TEAM_MILITIA, "npc_soldier", "mp_titanweapon_leadwall" )
}
